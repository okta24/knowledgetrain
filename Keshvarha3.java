...
public class Keshvarha3 extends Activity implements OnNavigationListener {
    private static final String KEY_SELECTED_PAGE = "KEY_SELECTED_PAGE";
    private static final String KEY_SELECTED_CLASS = "KEY_SELECTED_CLASS";
   // private static final ArrayList<TransformerItem> TRANSFORM_CLASSES;
   private static int[] keshvar_voice;
    private static String[] keshvar_name;
    private static int[] keshvar_images;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        keshvar_name=question_library.get_keshvar_name();
        keshvar_voice=question_library.get_sounds_of_keshvar();
       ...
       /* private static final int[] imgs = new int[] { R.drawable.ic_info, R.drawable.ic_play};*/
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            View view;
                ...
                frag_title.setText(keshvar_name[frag_position]);
                imageViewPosition.setImageResource(keshvar_images[frag_position]);
...
private  void play(){
    if (!isplaying) {
        mediaPlayer = MediaPlayer.create(baseContext,keshvar_voice[mPager.getCurrentItem()]);
        mediaPlayer.start();
